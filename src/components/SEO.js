...
function SEO({ description, title, bodyClass, image = null }) {
  ...
  return (
    <Helmet bodyAttributes={{ class: bodyClass }} title={title || defaultTitle}>
      ...
      <meta name="og:image" content={image || `https://redesign.jellydevelopment.com/media/img/SEO.png?testing=true`} />
      <meta name="twitter:image" content={image || `https://redesign.jellydevelopment.com/media/img/SEO.png?testing=true`} />
