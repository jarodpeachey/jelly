...
function SEO({ description, title, bodyClass }) {
  ...
  const image = "/media/img/seo.jpg?test=true";
  ...
  return (
    <Helmet bodyAttributes={{ class: bodyClass }} title={title || defaultTitle}>
      ...
      <link rel="icon" type="image/svg+xml" href="/media/img/icons/icon--rocket.png"></link>
      <meta name="og:image" content={`https://launchoutreach.com${image}?test=true`} />
      <meta name="twitter:image" content={`https://launchoutreach.com${image}?test=true`} />
